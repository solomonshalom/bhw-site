    ...
    <>
      ...
      >
        ...
        >
          ...
          <Text variant="lead">
            GitHub is providing $100 pizza grants to 500 Hack Clubs.{' '}
            ...
            >
              <Box sx={{ display: 'flex', alignItems: 'center' }}>
                <img
                  alt="2. "
                  style={{ height: '32px', width: '32px', marginRight: '12px' }}
                  src="https://cloud-e10qi7h3q-hack-club-bot.vercel.app/0frame_18.png"
                />
                <Text
                  sx={{
                    color: '#000',
              ...
              <img
                ...
                src="https://cloud-bpufnmh9d-hack-club-bot.vercel.app/0samplevideo-min.gif"
              />
              <Box>
                <Button
                  variant="cta"
            ...
            >
              <Box sx={{ display: 'flex', alignItems: 'center' }}>
                <img
                  alt="3."
                  style={{ height: '32px', width: '32px', marginRight: '12px' }}
                  src="https://cloud-et18ikluu-hack-club-bot.vercel.app/0group_14.png"
                />
                <Text
                  sx={{
                    color: '#000',
              ...
              >
                Receive a Pizza Grant through HCB & use your HCB Virtual Card to
                order pizzas
              </Text>
              <Tilt
                sx={{
